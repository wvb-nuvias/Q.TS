...
function sidebarColor(a){
    ...
    a.setAttributeNode(att);a.classList.toggle("border-white");
...
function toggle_sidenav_mini(){
    if(pageName!="rtl-page"){
        if(sidenav.getAttribute("mini")=="true"){
            normal_sidenav();sidenav.setAttribute("mini","false");
        }else{
            mini_sidenav();sidenav.setAttribute("mini","true");
        }
    }else{
        if(sidenav.getAttribute("mini")=="true"){
            normal_sidenav_rtl();sidenav.setAttribute("mini","false");
        }else{
            mini_sidenav_rtl();sidenav.setAttribute("mini","true");
        }
    }
}
