            ...
            <nav>
                <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                    <li class="text-sm leading-normal breadcrumb-item">
                        <a class="dark:text-white" href="javascript:;">
                            <i class="leading-none fa fa-box"></i>
                        </a>
                    </li>
                    <li class="text-sm pl-2 leading-normal before:float-left before:pr-2 before:dark:text-white before:content-['/']">
                        <a class="dark:text-white opacity-50" href="javascript:;">Pages</a>
                    </li>
                    <li class="text-sm pl-2 capitalize leading-normal dark:text-white before:float-left before:pr-2 before:dark:text-white before:content-['/']" aria-current="page">{{Route::currentRouteName()}}</li>
                </ol>
            ...
            <div class="flex items-center">
                <a mini-sidenav-burger href="javascript:;" class="hidden p-0 text-sm dark:text-white transition-all ease-nav-brand xl:block" aria-expanded="false">
                    <div class="w-4.5 overflow-hidden">
                        ...
                        <i class="ease relative block h-0.5 rounded-sm bg-black dark:bg-white transition-all translate-x-[5px]"></i>
                    </div>
                </a>
            </div>
