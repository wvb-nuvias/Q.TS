<div>
    <x-layouts.tspage themecolor1="{{$user->setting('themecolor1')}}" themecolor2="{{$user->setting('themecolor2')}}" themeheader="img/header/header4.jpg" icon="code-compare" iconcolor="cyan" title="integrations" subtitle="integrations Management" :user="$user">
        <x-slot name="header">
        ...
        <x-slot name="content">
            <x-panel title="Active Integrations" extracss="mt-6">
                ...
                <div class="w-full px-6 mx-auto space-y-6 pt-6">
                    <div class="flex flex-wrap -mx-3">
                        ...
                        <div class="w-full px-3 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4 pt-3">
            ...
            <x-panel title="Inactive Integrations" extracss="mt-6 opacity-20 hover:opacity-100">
                <x-panel.subtitle extracss="-mt-4">
